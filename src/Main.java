...
public class Main {
	...
	public static void main(String[] args) {
		...
		*/
		...
		Dev devPaulelli = new Dev();
		devPaulelli.setNome("Paulelli");
		devPaulelli.inscreverBootcamp(bootcamp);
		System.out.println("Conteúdos Inscritos" + devPaulelli.getConteudosInscritos());
		devPaulelli.progredir();
		devPaulelli.progredir();
		devPaulelli.progredir();
		System.out.println("-");
		System.out.println("Conteúdos Inscritos" + devPaulelli.getConteudosInscritos());
		System.out.println("Conteúdos Concluídos" + devPaulelli.getConteudosConcluidos());
		System.out.println("XP: " + devPaulelli.calcularTotalXp());
	}
